...
#  where heights[row][col] represents the height of cell 
# (row, col). You are situated in the top-left cell,
#  (0, 0), and you hope to travel to the bottom-right
#  cell, (rows-1, columns-1) (i.e., 0-indexed). 
# You can move up, down, left, or right, and you wish
...
# Output: 2
# Explanation: The route of [1,1,2,4,4] has a maximum 
...
# Output: 1
# Explanation: The route of [1,1,1,1,1,2,2] has a
#  maximum absolute difference of 1 in consecutive cells.
...
solution.minimumEffortPath(heights=heights)